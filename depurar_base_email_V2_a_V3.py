...
# Se toma el archivo "Base email para validar V2" y se depuran
...
path = 'C:/Users/AG/Documents/01 - solution/Emailing/Base mail para validar V2 - 2021-12-15.csv'
df = pd.read_csv(path)
...
# Crear un df que contenta la palabra clave
...
path2 = 'C:/Users/AG/Documents/01 - solution/Emailing/conteo dominios.csv'
conteo.to_csv(path2)

empresa = 'home'
domino = 'home.com'

empresa = df[df['domain']== domino]
empresa['filename'].value_counts()